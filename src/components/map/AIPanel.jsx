      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3 min-h-0">
        {messages.map((msg, i) => (
          <div key={i} className={`flex gap-2 ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
            {msg.role === "assistant" && (
              <img src="https://media.base44.com/images/public/69ad3ce309822f8e71f66838/75ef0a326_EZU3mXIlM90xjxOrcrhU--0--SNgLs.jpg" alt="Franc" className="w-6 h-6 rounded-full object-cover shrink-0 mt-0.5" />
            )}
        ...
        {loading && (
          <div className="flex gap-2">
            <img src="https://media.base44.com/images/public/69ad3ce309822f8e71f66838/75ef0a326_EZU3mXIlM90xjxOrcrhU--0--SNgLs.jpg" alt="Franc" className="w-6 h-6 rounded-full object-cover shrink-0" />
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-4 py-3 shrink-0" style={{ borderBottom: `1px solid ${theme.panelText}18` }}>
        <img src="https://media.base44.com/images/public/69ad3ce309822f8e71f66838/f359a4c9b_Screenshot355.png" alt="Franc" className="w-7 h-7 rounded-lg object-cover" />
