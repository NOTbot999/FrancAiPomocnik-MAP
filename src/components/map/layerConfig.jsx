  ...
  // ── INFRASTRUKTURA ───────────────────────────────────────────
  {
    ...
    layers: [
      ...
      },
      {
        ...
        layers: "SI.GURS.KGI:LINIJE_VODOVOD_G,SI.GURS.KGI:LINIJE_KANALIZACIJA_G",
        format: "image/png",
        transparent: true,
        version: "1.3.0",
        opacity: 0.8,
  ...
  // ── NARAVA & OKOLJE ──────────────────────────────────────────
  {
    ...
    layers: [
      // Vodne površine — WMS iz ARSO
      {
        ...
        type: "wms",
        url: ARSO_WMS,
        layers: "ARSO:VODE_MM_PVOPV_KEM_ST_2020",
        format: "image/png",
        transparent: true,
        version: "1.1.1",
        opacity: 0.85,
      ...
      },
      {
        ...
        opacity: 0.85,
        thumbnail: "https://images.unsplash.com/photo-1559825481-12a05cc00344?w=80&h=60&fit=crop",
        description: "Vodna telesa iz ARSO registra voda — reke, potoki in jezera v Sloveniji"
      },
      {
        id: "arso_poplave",
    ...
    layers: [
      {
        ...
        type: "arcgis_export",
        url: "https://gis.arso.gov.si/arcgis/rest/services/Tla/MapServer/export",
        bboxSR: 4326,
        imageSR: 4326,
        transparent: true,
        format: "png32",
      ...
      {
        id: "arso_erozija",
        name: "Degradirana / erozijo ogrožena območja",
        type: "arcgis_export",
        url: "https://gis.arso.gov.si/arcgis/rest/services/Degradirana_obmocja/MapServer/export",
        bboxSR: 4326,
        imageSR: 4326,
        transparent: true,
        format: "png32",
  ...
  // ── ENERGIJA & INFRASTRUKTURA ─────────────────────────────────
  {
    ...
    layers: [
      ...
      },
      {
        ...
        type: "wms",
        url: "https://ipi.eprostor.gov.si/wms-si-gurs/ows",
        layers: "SI.GURS.KGI:LINIJE_NAFTA_IN_NAFTNI_DERIVATI_G,SI.GURS.KGI:LINIJE_ZEMELJSKI_PLIN_G",
        format: "image/png",
        transparent: true,
        version: "1.3.0",
        opacity: 0.8,
