...
export default function MapViewer() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden" style={{ backgroundColor: "#e8ede8", backgroundImage: "url('https://media.base44.com/images/public/69ad3ce309822f8e71f66838/b15473e19_5992128811794894233.jpg')", backgroundSize: "contain", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
      ...
      {isMobile && is3DOpen && (
        <>
          {/* Top bar with main tools */}
          <div className="absolute top-3 left-3 right-3 z-[960] flex items-center gap-2" style={{ pointerEvents: "auto" }}>
            {/* Search button */}
            <button
              onClick={() => setFlyToLocation(null)} // Triggers search bar in MobileTopBar style
              className="flex-1 flex items-center justify-center rounded-xl border border-slate-400/40 shadow-md bg-black/40 backdrop-blur px-3 py-2"
              style={{ color: "#fff" }}
              title="Iskanje"
            >
